...
/// A namespace for uni colors, bridging system colors to SwiftUI across all Apple platforms.
///
/// `UniColor` provides a unified API to access system-defined colors (like separators,
...
/// Text("Uni Text")
///     .padding()
///     .background(UniColor.systemBackground)
///     .foregroundColor(UniColor.label)
/// ```
public struct UniColor {
    ...
    /// An uni mint color. Falls back to a simulated mint on iOS 13/14.
    ...
    /// An uni teal color. Falls back to a simulated teal on iOS 13/14.
    ...
    /// An uni cyan color. Falls back to a simulated cyan on iOS 13/14.
    ...
    /// An uni indigo color. Falls back to a simulated indigo on iOS 13/14.
    ...
    /// An uni brown color. Falls back to a simulated brown on iOS 13/14.
