...
///
/// `UniViewThatFits` provides a bridge for the `ViewThatFits` component:
...
/// Example:
/// ```swift
/// UniViewThatFits(in: .horizontal) {
///     HStack { /* Long content */ }
///     VStack { /* Compact content */ }
/// }
/// ```
public struct UniViewThatFits<Content: View>: View {
    private let axes: UniViewThatFitsAxes
    private let content: () -> Content

    /// Creates an uni view that fits.
    ///
    /// - Parameters:
    ...
    public init(
        in axes: UniViewThatFitsAxes = .horizontal,
