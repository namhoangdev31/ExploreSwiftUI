...
public struct AdaptiveTabBuilder<Value: Hashable> {
    public static func buildBlock(_ components: _AdaptiveTabDescriptor<Value>...)
        -> [_AdaptiveTabDescriptor<Value>]
    {
        Array(components)
    }
    ...
    public static func buildOptional(_ component: [_AdaptiveTabDescriptor<Value>]?)
        -> [_AdaptiveTabDescriptor<Value>]
    {
        component ?? []
    }

    public static func buildEither(first component: [_AdaptiveTabDescriptor<Value>])
        -> [_AdaptiveTabDescriptor<Value>]
    {
        component
    }

    public static func buildEither(second component: [_AdaptiveTabDescriptor<Value>])
        -> [_AdaptiveTabDescriptor<Value>]
    {
        component
    }
