...
@Test(
    "RSS_CASE_VALIDATE (1 item = 1 test case)",
    arguments: ExploreSwiftUIRSSParameterizedData.caseArguments)
...
@Test(
    "RSS_COMPONENT_VALIDATE (1 component = 1 test case)",
    arguments: ExploreSwiftUIRSSParameterizedData.componentExpectations)
func rssComponentCoverage(_ expectation: RSSComponentExpectation) {
    let actualCount = ExploreSwiftUIRSSParameterizedData.feed.items.filter {
        $0.component == expectation.component
    }.count
