...
/// }
/// ```
public struct UniGlassContainer<Content: View>: View {
...
extension View {
    ...
    /// ```swift
    /// MyView()
    ///     .uniGlass(cornerRadius: 16, tint: .blue.opacity(0.2))
    /// ```
    @ViewBuilder
    public func uniGlass(
        cornerRadius: CGFloat = 20,
        tint: Color? = nil,
        interactive: Bool = false,
        fallbackMaterial: UniMaterialStyle = .ultraThin,
        ...
        if #available(iOS 26.0, macOS 26.0, tvOS 26.0, watchOS 26.0, visionOS 26.0, *) {
            ...
            self
                .uniMaterialBackground(fallbackMaterial, cornerRadius: cornerRadius)
                .shadow(
    ...
    /// ```swift
    /// Button("Action") {}
    ///     .uniGlassButton(.prominent)
    /// ```
    @ViewBuilder
    public func uniGlassButton(
        _ variant: UniGlassButtonVariant = .regular,
        cornerRadius: CGFloat = 20
    ) -> some View {
        if #available(iOS 26.0, macOS 26.0, tvOS 26.0, watchOS 26.0, visionOS 26.0, *) {
            switch variant {
    ...
    @ViewBuilder
    public func uniBackgroundExtension(isEnabled: Bool = true) -> some View {
        if #available(iOS 26.0, macOS 26.0, tvOS 26.0, watchOS 26.0, visionOS 26.0, *) {
