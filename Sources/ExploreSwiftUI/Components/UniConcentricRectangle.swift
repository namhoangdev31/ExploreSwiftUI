...
/// An uni representation of the modern `ConcentricRectangle` shape.
///
/// `UniConcentricRectangle` provides a bridge for the advanced geometry features
...
/// Example:
/// ```swift
/// UniConcentricRectangle(fallbackCornerRadius: 30)
///     .stroke(Color.blue, lineWidth: 2)
///     .frame(width: 200, height: 100)
/// ```
public struct UniConcentricRectangle: InsettableShape {
    public var fallbackCornerRadius: CGFloat
    public var isUniform: Bool
    public var insetAmount: CGFloat = 0

    /// Creates an uni concentric rectangle.
    ///
    /// - Parameters:
    ...
    public func inset(by amount: CGFloat) -> UniConcentricRectangle {
        var shape = self
