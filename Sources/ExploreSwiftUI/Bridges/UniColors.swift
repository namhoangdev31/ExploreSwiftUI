...
extension View {
    ...
    /// Applies an uni foreground style with support for hierarchical variants and gradients.
    ///
        ...
        opacity: Double = 1.0
            ...
            if #available(iOS 17.0, macOS 14.0, watchOS 10.0, tvOS 17.0, visionOS 1.0, *) {
                if gradient {
                    ...
                    case .quaternary:
                        self.foregroundStyle(color.gradient.quaternary.opacity(opacity))
                ...
                if gradient {
                    ...
                    self.foregroundStyle(
                        color.gradient.opacity(opacity * hierarchy.simulatedOpacity))
                } else {
...
extension UniColorHierarchy {
    ...
    fileprivate var simulatedOpacity: Double {
        switch self {
