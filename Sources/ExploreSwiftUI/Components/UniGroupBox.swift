...
///
/// `UniGroupBox` provides a bridge for the `GroupBox` component:
...
///   uni system colors to maintain visual consistency on older systems.
///
/// Example:
/// ```swift
/// UniGroupBox("Settings") {
///     Toggle("Enable Notifications", isOn: $isEnabled)
/// }
/// ```
public struct UniGroupBox<Label: View, Content: View>: View {
