...
extension View {
    ...
    /// Sets the order of items within an uni menu.
    ///
    ...
    ///     Button("Edit") { }
    /// }
    /// .uniMenuOrder(.priority)
    /// ```
    @ViewBuilder
    public func uniMenuOrder(_ order: UniMenuOrder) -> some View {
    ...
    /// Adds an uni context menu with optional preview support.
    ///
    ...
    /// ```
    @ViewBuilder
    public func uniContextMenu<MenuItems: View, Preview: View>(
