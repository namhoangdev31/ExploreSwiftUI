...
/// An uni component that presents a label and a related value content.
///
/// `UniLabeledContent` provides a bridge for the `LabeledContent` API:
...
/// ```
public struct UniLabeledContent<Label: View, Content: View>: View {
    ...
    /// Creates an uni labeled content with custom views for both label and content.
...
extension UniLabeledContent where Label == Text, Content == Text {

    // MARK: - String-based Initializers

    /// Creates an uni labeled content using a title string and a value string.
    ...
    /// Creates an uni labeled content using a localized title key and a value string.
    ...
    /// Creates an uni labeled content using a format style for the value.
    ///
    /// Example:
    /// ```swift
    ...
    /// Creates an uni labeled content with a localized title and a format style for the value.
    @available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, *)
