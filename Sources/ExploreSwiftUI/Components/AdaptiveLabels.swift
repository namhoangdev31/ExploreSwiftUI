...
extension AdaptiveLabel where Title == Text, Icon == Image {
...
extension EnvironmentValues {
    ...
    public var adaptiveLabelStyle: AdaptiveLabelStyleType {
...
extension View {
    ...
    /// ```
    @ViewBuilder
    public func adaptiveLabelStyle(_ style: AdaptiveLabelStyleType) -> some View {
        if #available(iOS 14.0, macOS 11.0, watchOS 7.0, tvOS 14.0, visionOS 1.0, *) {
...
extension View {
    @ViewBuilder
    fileprivate func applyNativeLabelStyle(_ style: AdaptiveLabelStyleType) -> some View {
        switch style {
        case .iconOnly:
