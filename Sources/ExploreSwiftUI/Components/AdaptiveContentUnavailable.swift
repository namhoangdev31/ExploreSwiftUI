...
extension AdaptiveContentUnavailableView
where Label == EmptyView, Description == EmptyView, Actions == EmptyView {

    /// A pre-built adaptive placeholder for empty search results.
    public static var search: AdaptiveContentUnavailableView<EmptyView, EmptyView, EmptyView> {
    ...
    public static func search(text: String) -> AdaptiveContentUnavailableView<
