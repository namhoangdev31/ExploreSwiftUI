...
extension View {
    ...
    /// ```
    @ViewBuilder
    public func adaptivePresentationSizing(_ sizing: AdaptiveSheetSizing) -> some View {
    ...
    /// ```
    @ViewBuilder
    public func adaptivePresentationDetents(_ detents: [AdaptivePresentationDetent]) -> some View {
    ...
    @ViewBuilder
    public func adaptivePresentationDetents(
    ...
    @ViewBuilder
    public func adaptivePresentationCornerRadius(_ radius: CGFloat?) -> some View {
        if let radius {
    ...
    /// ```
    @ViewBuilder
    public func adaptivePresentationBackground<S: ShapeStyle>(_ style: S) -> some View {
        if #available(iOS 16.4, macOS 13.3, tvOS 16.4, watchOS 9.4, visionOS 1.0, *) {
    ...
    @ViewBuilder
    public func adaptivePresentationBackgroundInteraction(
    ...
    @ViewBuilder
    public func adaptivePresentationContentInteraction(
    ...
    @ViewBuilder
    public func adaptivePresentationDragIndicator(_ visibility: Visibility = .automatic)
        -> some View
    {
        if #available(iOS 16.0, macOS 13.0, tvOS 16.0, watchOS 9.0, visionOS 1.0, *) {
    ...
    @ViewBuilder
    public func adaptiveInteractiveDismissDisabled(_ isDisabled: Bool = true) -> some View {
...
extension AdaptivePresentationDetent {
