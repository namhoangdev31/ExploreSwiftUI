...
extension View {
    ...
    /// ```
    @ViewBuilder
    public func adaptiveBackgroundMaterial(_ type: AdaptiveMaterialType = .regular) -> some View {
    ...
    /// ```
    @ViewBuilder
    public func adaptiveForegroundMaterial(_ type: AdaptiveMaterialType = .regular) -> some View {
