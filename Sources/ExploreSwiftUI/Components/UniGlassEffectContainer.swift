...
///
/// `UniGlassEffectContainer` provides a unified layout for components with glass effects:
...
/// Example:
/// ```swift
/// UniGlassEffectContainer(spacing: 20) {
///     Text("Top Item").uniGlassEffect()
///     Text("Bottom Item").uniGlassEffect()
/// }
/// ```
public struct UniGlassEffectContainer<Content: View>: View {
    public var spacing: CGFloat?
    @ViewBuilder public var content: () -> Content

    /// Creates an uni glass effect container.
    ///
    /// - Parameters:
