...
///
/// `UniSlider` provides a unified API for sliders across all platforms:
...
/// Example:
/// ```swift
/// UniSlider(value: $volume, in: 0...100, step: 1) {
///     Text("Volume")
/// } minimumValueLabel: {
///     Text("0")
/// } maximumValueLabel: {
...
/// }
/// ```
public struct UniSlider<Label: View, ValueLabel: View, Ticks: View>: View {
    ...
    /// Creates an uni slider with labels and ticks.
    ///
    /// - Parameters:
    ...
    /// Creates a simplified uni slider without ticks or value labels.
    public init(
        value: Binding<Double>,
        in bounds: ClosedRange<Double> = 0...1,
        step: Double = 0.001,
    ...
    public func uniTint(_ color: Color?) -> UniSlider {
        let copy = self
        // Logic for tinting is handled via the uniSliderTint modifier in body.
        return copy
    }
}
